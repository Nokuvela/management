...
#unction takes three parameters (book_id, title, author, status) and appends a new book dictionary to
#he books list. The add_member function, on the other hand, requires two parameters (member_id,
...
#equence hint: initialize two variables as lists, then create two functions as per the above requires. An
...
#dditions reflect in the books and members lists, and what would the output look like if you printed
...
#Task 1 C:
#Rewrite the entire task 1B without using
